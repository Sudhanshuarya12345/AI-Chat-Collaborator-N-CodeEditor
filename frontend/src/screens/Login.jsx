          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                {showPassword ? (
                  // Eye-slash (hide) icon
                  <svg className="password-toggle-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-5 0-9.27-3.11-11-7.5a11.64 11.64 0 012.92-4.36M6.22 6.22A9.956 9.956 0 0112 5c5 0 9.27 3.11 11 7.5a11.64 11.64 0 01-4.21 5.09M15 12a3 3 0 11-6 0 3 3 0 016 0zM3 3l18 18" />
                  </svg>
                ) : (
                  // Eye (show) icon
                  <svg className="password-toggle-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
